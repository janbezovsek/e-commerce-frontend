//the same data as in data.js except we got rid of types as electronics,
//watches, handbags and sofas because I had troubles of filtering titles 
//from data.js 
...
let dataProductsList = [
    ...
    },
    {
        ...
        quantity: 16,
        image: img9,
        description: "The Electrolux EW2F5W82 washing machine is equipped with the GentleCare basket, specially designed to take care of your clothes. With the Sanitizing Steam program you can remove more than 99.99% of viruses and bacteria.",
        price: "750.00",
        info: "Colour: White Inverter PowerDrive motor WaveActive drum Washing capacity: 10 kg Drum volume: 68 Control: Button Type of display: LED display Drum illumination: Yes Cold wash: 15 °C",
        type: "electronics"
    },
    {
        id: 10,
        ...
        quantity: 12,
        image: img10,
        description: "Washing machine · WE843 Energy efficiency class: D, Washing capacity: 8 kg, Construction type: Freestanding, Width of the product: 600 mm, Height of the product: 850 mm",
        price: "620.00",
        info: "Colour: White Inverter PowerDrive motor WaveActive drum Washing capacity: 10 kg Drum volume: 68 Control: Button Type of display: LED display Drum illumination: Yes Cold wash: 15 °C",
        type: "electronics"
    },
    {
        ...
        quantity: 12,
        image: img11,
        description: "Washing machine  Washing capacity: 9 kg  Inverter PowerDrive motor",
        price: "720.00",
        info: "Colour: White Inverter PowerDrive motor WaveActive drum Washing capacity: 10 kg Drum volume: 68 Control: Button Type of display: LED display Drum illumination: Yes Cold wash: 15 °C",
        type: "electronics"
    },
    {
        ...
        quantity: 5,
        image: img12,
        description: "Front Load Washer 7KG , Direct Drive Motor, 6 Motion , Silver color",
        price: "520.00",
        info: "Colour: White Inverter PowerDrive motor WaveActive drum Washing capacity: 10 kg Drum volume: 68 Control: Button Type of display: LED display Drum illumination: Yes Cold wash: 15 °C",
        type: "electronics"
    },
    {
        ...
        quantity: 6,
        image: img13,
        description: "12kg capacity top load washing machine with easy to use controls, everyday fast wash programs and durable soft close glass lid.",
        price: "500.00",
        info: "Colour: White Inverter PowerDrive motor WaveActive drum Washing capacity: 10 kg Drum volume: 68 Control: Button Type of display: LED display Drum illumination: Yes Cold wash: 15 °C",
        type: "electronics"
    },
